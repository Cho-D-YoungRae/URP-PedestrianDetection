...
def basic_transform(image, bboxes, category_ids, is_crowds, ch_option):
    ...
    return new_image, new_bboxes, new_category_ids, new_is_crowds


def default_transform(image, bboxes, category_ids, is_crowds, ch_option):
    ...
    new_image, new_bboxes, new_category_ids, new_is_crowds = \
        random_crop(new_image, new_bboxes, new_category_ids, new_is_crowds)
